            ...
            <div className="gi-slider-content">
              <div className="gi-main-slider">
                <>
                  ...
                  >
                  <SwiperSlide
  className="gi-slide-item swiper-slide d-flex slide-1"
  style={{
    backgroundImage: "url('https://images.pexels.com/photos/417173/pexels-photo-417173.jpeg?auto=compress&cs=tinysrgb&h=700&w=1800')",
